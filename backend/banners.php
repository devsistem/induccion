...
// todos 
$result_todos = $Banner->obtener_all(null, null);
...
<?php //+  acciones js // ?>
 ...
 function imagenes(idx) {
  var form = document.forms['frmPrincipal'];
  form['id'].value = idx;
  form.action = 'banners_imagenes.php';
  form.submit();
 }
</script>
<?php //-  acciones js // ?>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="noticias.php">Banners</a></li>
				<li class="active">Listado</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Banner <small>listado de Banners</small></h1>
			<!-- end page-header -->
                                ...
                                <table id="data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
	                                            <button type="button" class="btn btn-inverse" onClick="imagenes('<?=$items['id']?>')" ><i class="fa fa-cog"></i> Imagenes</button>
                                            </td>
                                        </tr>
                                  <?php
                                  } 
