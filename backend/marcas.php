...
switch ($accion) {
 case 'eliminar':
  if(is_array($_POST['arrSeleccion'])) foreach($_POST['arrSeleccion'] as $idx) {
 	  $Producto->eliminar_marca($idx);
   }
 break;
 
 case 'publicar':
	   $Producto->publicar_marca($_POST['id'], $_POST['campo']);
 break;
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="noticias.php">Productos Marcas</a></li>
				<li class="active">Listado</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Marcas <small>listado de Marcas</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="alert alert-success fade in">
                            ...
                            Marca ha sido eliminado correctamente.
                        </div>
	                      <?php } ?>
