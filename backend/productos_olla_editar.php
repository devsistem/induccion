...
// modelos cocina
$result_modelos_cocina = $Producto->obtener_modelos( ACTIVO, 'olla');
...
// modelos marca
$result_modelos_marca = $Producto->obtener_marcas( ACTIVO, 'olla');
...
<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active">Nueva Olla</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Productos<small> ingresar una nueva Olla</small></h1>
			<!-- end page-header -->
       ...
       <!-- begin row -->
			<div class="row">
              ...
              <form  name="frmEditar"  id="frmEditar" class="form-horizontal form-bordered" data-parsley-validate="true" method="POST">
              	...
              	<input type="hidden" name="tipo" value="olla" />
