...
switch ($accion) {
 case 'eliminar':
  if(is_array($_POST['arrSeleccion'])) foreach($_POST['arrSeleccion'] as $idx) {
 	  $Producto->eliminar_modelo($idx);
   }
 break;
 
 case 'publicar':
	   $Producto->publicar_modelo($_POST['id'], $_POST['campo']);
 break;

}

// todos 
$result_todos = $Producto->obtener_modelos(null, null);
...
<?php //+  acciones js // ?>
 ...
 function editar(idx) {
  var form = document.forms['frmPrincipal'];
  form['id'].value = idx;
  form.action = 'modelos_editar.php';
  form.submit();
 }
</script>
<?php //-  acciones js // ?>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="noticias.php">Productos Modelos</a></li>
				<li class="active">Listado</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Modelos <small>listado de Modelos</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="alert alert-success fade in">
                            ...
                            El Modelos ha sido eliminado correctamente.
                        </div>
	                      <?php } ?>
                                ...
                                <table id="data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
					   											...
					   											for($i=1; $i <= $filas_todos; $i++) {
																	  ...
																	  $arrMarca = $Producto->obtener_marca($items['id_marca']);
																	?>                                     	
                                        <tr class="odd gradeX">
