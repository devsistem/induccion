 ...
 case 'grabar':
  ...
  if ($errores == 0) {
     ...
     if ($id > 0) {
       ...
       $Producto->editar_color($id, $_POST);
			 print  "<script>window.location.href='colores.php?id=".$id."';</script>";
       exit;
       $accion = "actualizado";
     } 
     else
     {
     	 $last_id = $Producto->grabar_color($_POST);
			 print  "<script>window.location.href='colores.php?id=".$last_id."';</script>";
       exit;
       $accion = "actualizado";
     }
   }
...
if ($id > 0) {
  $item = $Producto->obtener_color($id);
}
...
<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Colores</a></li>
				<li class="active">Nuevo Color</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Colores<small> ingresar un nuevo color</small></h1>
			<!-- end page-header -->
