...
if($BackendUsuario->esSupervisor()) {
	...
	$result = $BackendUsuario->obtener_all(null, null, null, null, null, null, 1,  10, $BackendUsuario->getUsuarioId());
	$filas = @mysql_num_rows($result);
	
} else if($BackendUsuario->esGerenteVentas()) { 

	$result = $BackendUsuario->obtener_all(null, null, null, null, null, null, null, 10, null);
	$filas = @mysql_num_rows($result);
}
?>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="noticias.php">Vendedores</a></li>
				<li class="active">Listado</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Vendedores <small>listado de vendedores</small></h1>
			<!-- end page-header -->
