...
loadClasses('BackendUsuario',  'Banner');
global $BackendUsuario, $Banner;
...
$item = $Banner->obtener($id);
// todos 
$result_todos = $Banner->obtener_by_id($id, null, null);
...
<?php //+  acciones js // ?>
 ...
 function editar(idx) {
  var form = document.forms['frmPrincipal'];
  form['id'].value = idx;
  form.action = 'banners_imagenes_editar.php';
  form.submit();
 }
</script>
<?php //-  acciones js // ?>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="noticias.php">Banners <?=$item['nombre']?></a></li>
				<li class="active">Listado</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Banner <small>listado de imagenes del banner <?=$item['nombre']?></small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Banner <?=$item['nombre']?></h4>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table id="data-table" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th width="1%" class="sorting_desc_disabled"><button type="button" class="btn btn-primary btn-xs m-r-5" onClick="eliminar('<?=$items['id']?>')" onClick="eliminar()" title="Eliminar seleccionados">Eliminar Seleccion</button></th>
                                            <th width="1%">Id</th>
                                            <th width="20%"></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                           		<img src="<?=URL_PATH_ROOT?>/adj/banners/<?=$items['imagen']?>">
                                           	</td>
                                            <td><?=$items['nombre']?>
