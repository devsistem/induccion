 ...
 case 'grabar':
  ...
  if ($errores == 0) {
     ...
     if ($id > 0) {
       ...
       $Producto->editar_modelo($id, $_POST);
			 print  "<script>window.location.href='modelos.php?id=".$id."';</script>";
       exit;
       $accion = "actualizado";
     } 
     else
     {
     	 $last_id = $Producto->grabar_modelo($_POST);
...
if ($id > 0) {
  $item = $Producto->obtener_modelo($id);
}

$result_todos = $Producto->obtener_marcas(null, null);
...
<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Modelos</a></li>
				<li class="active">Nuevo Modelo</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Modelos<small> ingresar un nuevo Modelo</small></h1>
			<!-- end page-header -->
