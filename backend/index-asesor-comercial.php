...
loadClasses('BackendUsuario',  'Producto', 'Incidencia', 'Reporte','Pedido');
global $BackendUsuario, $Producto, $Incidencia, $Reporte,$Pedido;
		...
		<div id="content" class="content">
          ...
          <?php if($BackendUsuario->esVendedor()) { 
          	...
          	$cantidad_despachos_vendedor = $Pedido->cantidad_pedidos_by_vendedor($BackendUsuario->getUsuarioId(), 5);
					  $cantidad_recepcion_vendedor = $Pedido->cantidad_pedidos_by_vendedor($BackendUsuario->getUsuarioId(), 6);
					  $cantidad_entrega_vendedor   = $Pedido->cantidad_pedidos_by_vendedor($BackendUsuario->getUsuarioId(), 7);
			    ...
			    <div class="col-md-12">
			    	...
			    	<div class="panel panel-inverse" data-sortable-id="index-5">
						<div class="panel-heading">
							...
							<h4 class="panel-title">Reglamento Interno</h4>
						</div>
						<div class="panel-body">
								...
								<ul class="media-list media-list-with-divider media-messaging">
									<li class="media media-sm">
										<div class="media-body">
											<h5 class="media-heading">Sistema</h5>
											<p>Actualizacion del panel de los asesores comerciales</p>
										</div>
									</li>
