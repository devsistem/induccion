...
switch ($accion)
{
    ...
    */
    ...
    case 'estado':
        ...
        break;
    case 'estado-pedido':
        if (is_array($_POST['arrSeleccion2']))
            foreach ($_POST['arrSeleccion2'] as $idx)
              {
...
?>                                              
																								...
																								<?php
        if (!file_exists("../adj/pedidos/" . $items['imagen_factura_g']))
          {
?>
...
?>
																								...
																								<?php
        if (!file_exists("../adj/pedidos/" . $items['imagen_dni_frente_g']))
          {
?>
...
?>
																								...
																								<?php
        if (!file_exists("../adj/pedidos/" . $items['imagen_dni_posterior_g']))
          {
?>
...
?>
                                            ...
                                            <td><button type="button" class="btn btn-default m-r-5 m-b-5" onClick="editar('<?= $items['id'] ?>')">Editar</button></td>
                                        </tr>
                                  <?php
      }
  } // f pedidos
...
?>
																								<?php
    if (strlen($items['imagen_dni_frente_g']) > 11 && strlen($items['imagen_dni_posterior_g']) > 11)
      {
?>
...
?>
			                                          ...
			                                          <?php
    if (strlen($items['imagen_factura_g']) > 11)
      {
?>
...
?>
	          	                                  	<?php
        if (strlen($items['imagen_dni_duenio_frente_g']) > 11 && strlen($items['imagen_dni_duenio_posterior_g']) > 11)
          {
?>
...
?>
	                	                            	<?php
        if (strlen($items['imagen_duenio_garante_g']) > 11)
          {
?>
...
?>
                                            ...
                                            <td><?= $items['id'] ?></td>
                                            <td>
                                            	<a href="javascript:editarPedido('<?= $items['id'] ?>')"><strong><?= $items['cliente_dni'] ?></strong></a></td>
                                            <td><?= $items['cliente_nombre'] ?></td>
                                            <td><?= $items['cliente_apellido'] ?></td>
                                            <td><?= $items['modelo'] ?> <?= $items['marca'] ?> <?= $items['color'] ?></td>
                                            <td>
...
?>                                     	
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                            	...
                                            	<a href="javascript:editarPedidoF7('<?= $items['id'] ?>')"><strong><?= $items['cliente_dni'] ?></strong></a></td>
                                            </td>
                                            <td><?= $items['cliente_nombre'] ?></td>
                                            <td><?= $items['cliente_apellido'] ?></td>
                                            <td><?= $items['modelo'] ?> <?= $items['marca'] ?> <?= $items['color'] ?></td>
