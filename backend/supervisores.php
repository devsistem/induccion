...
if(!$BackendUsuario->esGerenteGeneral() && !$BackendUsuario->esSupervisor() && !$BackendUsuario->esGerenteVentas() && !$BackendUsuario->esRoot()  && !$BackendUsuario->esSupervisor()) {
 die;
}
...
// solo muestra sus vendeores SI ES SUPERVISOR
if($BackendUsuario->esSupervisor()) {

	$result = $BackendUsuario->obtener_all(null, null, null, null, null, null, 1,  4, $BackendUsuario->getUsuarioId());
	$filas = @mysql_num_rows($result);
	
} else if($BackendUsuario->esGerenteVentas()) { 

	$result = $BackendUsuario->obtener_all(null, null, null, null, null, null, null, 4, null);
	$filas = @mysql_num_rows($result);
}
?>
...
<?php //+  acciones js // ?>
 ...
 function editar(idx) {
  var form = document.forms['frmPrincipal'];
  form['id'].value = idx;
  form.action = 'vendedores_editar.php';
  form.submit();
 }
 function buscar() {
  var form = document.forms['frmPrincipal'];
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="noticias.php">Supervisores</a></li>
				<li class="active">Listado</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Supervisores <small>listado de supervisores</small></h1>
			<!-- end page-header -->
                                ...
                                <table id="data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td> <img src="<?=URL_PATH_ROOT?>/adj/vendedores/<?=$items['imagen']?>" border="1" width="50" height="50"> </td>
                                            <td>
