...
$result = $BackendUsuario->obtener_all($paginacion, $porPagina, $usuario, $email, $nombre, null, null);
...
function editar(idx) {
 var form = document.forms['frmPrincipal'];
 form['id'].value = idx;
 form.action = 'edit_administrador.php';
 form.submit();
}
</script>
</head>
<body>
	...
	<div id="page-container" class="fade">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Administradores<small> Listado los administradores de biciq</small></h1>
			<!-- end page-header -->
