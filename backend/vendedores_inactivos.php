...
// solo inactivos
$result = $BackendUsuario->obtener_vendedores_inactivos(null);
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="noticias.php">Vendedores Inactivos</a></li>
				<li class="active">Listado</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Vendedores <small>listado de vendedores Inactivos</small></h1>
			<!-- end page-header -->
