<?php
// incidencias_editar.php
// 7
ob_start();
include_once("config/conn.php");
declareRequest('accion','id','arrSeleccion', 'porPagina', 'paginacion', 'palabra');
loadClasses('BackendUsuario','Incidencia');
global $BackendUsuario,$Incidencia;
 ...
 case 'grabar':
  ...
  if ($errores == 0) {
     ...
     if ($id > 0) {
       ...
       $Incidencia->editar($id, $_POST);
			 print  "<script>window.location.href='incidencias.php?id=".$id."';</script>";
       exit;
     ...
     {
     	 $last_id = $Incidencia->grabar($_POST);
       header("Location: incidencias.php?id=".$last_id."");
       exit;
       $accion = "actualizado";
     }
   }
...
<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Incidencias</a></li>
				<li class="active">Nueva Incidencia</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Incidencia<small> ingresar un nueva Incidencia</small></h1>
			<!-- end page-header -->
              ...
              <form  name="frmEditar"  id="frmEditar" class="form-horizontal form-bordered" data-parsley-validate="true" method="POST">
	              ...
	              <?php } ?>	
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" id="nombre" name="nombre"  maxlength="50" required="true" value="<?=$item['nombre']?>"/>
									</div>
								</div>

								<div class="form-group">
									<label class="control-label col-md-2 col-sm-2" for="fullname">Descripcion:</label>
									<div class="col-md-6 col-sm-6">
										<textarea class="form-control" id="contenido" name="contenido"  maxlength="100"><?=$item['contenido']?></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										...
										o
										<a href="incidencias.php">cancelar</a>
									</div>
								</div>
               </form>
             </div>
