                               ...
                               <div class="alert alert-success fade in">
	                            ...
	                            <?php } ?>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                            	<span style="font-size:11px">
                                            	(<?=$items['id_vendedor']?>) <?=$items['backend_nombre']?> <?=$items['backend_apellido']?>
                                            </span>
                                            	</td>
                                            <td align="center">
                                            	<span style="font-size:11px">
                                            ...
                                            <td align="center">
                                             <input type="checkbox" name="ck_comicionar" value="<?=$items['id']?>" onClick="comicionar('<?=$items['id']?>');"/>
                                            </td>
                                            <td>
																						...
																						?>	
																						 ...
																						 <?php if(strlen($arrIncidencia['nombre']) > 0) { ?>
																							 <label class="label label-danger"> <?=$arrIncidencia['nombre']?> </label>
																						 <?php } ?>
