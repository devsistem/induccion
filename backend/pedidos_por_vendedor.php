...
if($e > 0) {  
	$result_todos = $Pedido->obtener_all($porPagina, $paginacion, $limite, $palabra, $order_by, $filtro, ACTIVO, $e, $destacado, $filtro_id_tipo, $filtro_id_categoria, $filtro_id, $id_vendedor, null, null, null, null, null, $filtro_cedula, $filtro_id_provincia, $filtro_nombre, $filtro_apellido, $filtro_id_vendedor);
	$filas_todos = @mysql_num_rows($result_todos);
} else {
	$result_todos = $Pedido->obtener_all_baja($porPagina, $paginacion, $limite, $palabra, $order_by, $filtro, NULL, 1, $destacado, $filtro_id_tipo, $filtro_id_categoria, null, $id_vendedor, null, null, null, null, null, $filtro_cedula, $filtro_id_provincia, $filtro_nombre, $filtro_apellido, $filtro_id_vendedor);
	$filas_todos = @mysql_num_rows($result_todos);
}
?>
...
<head>
	<meta charset="utf-8" />
	<title>Pedidos por vendedor-  Induccion</title>
